...
export function SecurityCard({ title, description, ip, typeColor, children }: SecurityCardProps) {
    return (
        <Card className={`group rounded-2xl cursor-pointer border-t-5 ${typeColor === 'black' ? 'border-gray-900 ' : 'border-blue-600 '} px-4 py-4 shadow-sm flex flex-col gap-1 transition-all duration-300 transform hover:scale-[1.01]
