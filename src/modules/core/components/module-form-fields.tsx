...
import type { ModuleFormValues } from "./module-form-schema";
...
export function ModuleFormFields({ register, errors }: ModuleFormFieldsProps) {
    return (
        <div className="space-y-4">
            <div className="space-y-2">
                <Label htmlFor="ds_name">Nome</Label>
                <Input id="ds_name" placeholder="Ex.: Central de Tickets" {...register("ds_name")} />
                {errors.ds_name && (
